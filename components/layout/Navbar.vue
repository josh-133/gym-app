...
const pageTitle = computed(() => {
  ...
  return titles[route.path] || 'GymApp'
})
...
<template>
  <header class="h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 flex items-center justify-between">
    <!-- Left side -->
    <div class="flex items-center gap-4">
      ...
      <button
        class="hidden lg:flex p-2 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700"
    ...
    <div class="flex items-center gap-2">
      ...
      <NuxtLink to="/workout/new">
        <NButton type="primary" class="hidden sm:flex">
          <template #icon>
      ...
      >
        ...
        <!-- Moon icon -->
        <svg v-else-if="themeIcon === 'moon'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <button class="flex items-center gap-2 p-1 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
          <NAvatar
            round
            :size="36"
