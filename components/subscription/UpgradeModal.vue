...
const features = [
  {
    ...
    description: 'Get personalized workouts tailored to your goals and equipment',
  },
  {
    icon: 'trending',
    title: 'AI Insights',
    description: 'Receive intelligent analysis of your training patterns and progress',
  },
  {
    icon: 'bolt',
        ...
        <div class="features-list">
          <div v-for="feature in features" :key="feature.title" class="feature-item">
            <div class="feature-icon">
              <svg v-if="feature.icon === 'brain'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
