  ...
  <div class="animate-fade-in">
    <NCard class="shadow-2xl">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-500 dark:text-gray-400 mt-1">Start your fitness journey today</p>
      </div>
      ...
      <form v-if="!success" @submit.prevent="onSubmit">
        <NForm>
          <NFormItem label="Username" :validation-status="errors.username ? 'error' : undefined" :feedback="errors.username">
            <NInput
          ...
          <NFormItem label="Confirm Password" :validation-status="errors.confirmPassword ? 'error' : undefined" :feedback="errors.confirmPassword">
            <NInput
