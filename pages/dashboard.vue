...
const { getSuggestion } = useSmartSuggestions()

// Smart suggestion
const suggestion = computed(() => getSuggestion())
...
<template>
  <div class="space-y-6 animate-fade-in">
    ...
    <!-- Smart Suggestion -->
    <NuxtLink v-if="suggestion" :to="suggestion.templateId ? `/workout/new?template=${suggestion.templateId}` : '/workout/new'" class="block">
      <div class="card p-4 hover:shadow-md transition-shadow border-l-4 border-primary-500">
        <div class="flex items-center gap-4">
          ...
          <div class="flex-1">
            <p class="font-semibold text-primary-900 dark:text-white">Suggested: {{ suggestion.templateName }}</p>
            <p class="text-sm text-gray-500 dark:text-gray-400 capitalize">{{ suggestion.reason }}</p>
            <div class="flex flex-wrap gap-1 mt-1">
              <span
                v-for="muscle in suggestion.targetMuscles"
                :key="muscle"
